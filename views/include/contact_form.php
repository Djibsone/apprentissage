<section id="header">
    ...
    <div>
        <ul id="navbar">
            ...
            <li><a class="active" href="./contact"><i class="icon-phone"></i> Contact</a></li>
...
<section id="contact-details" class="section-p1">
    <div class="details">
        ...
        <div>
            <li>
                ...
                <p>56 Glassford Street Glasgow G1 1UL Bénin</p>
            </li>
        </div>
        <div>
            <li>
    ...
    <div class="map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15860.526405705641!2d2.4594789531441026!3d6.377007697811452!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103cab41e89f28ef%3A0x834886407fc6740!2sAkpakpa%20Avotrou!5e0!3m2!1sfr!2sbj!4v1682057872847!5m2!1sfr!2sbj" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</section>
...
<section id="form-details">
    ...
    <div class="people">
        <div>
            ...
            <p><span>Djibs Tam</span> Developper Web <br> Phone: +000 145 000 77 88 <br> Email: contact@gmail.com</p>
        </div>
        <div>
            <img src="./public/images/hero-men3.png" alt="">
            <p><span>Emma Stom</span> Developper Web <br> Phone: +000 145 000 77 88 <br> Email: contact@gmail.com</p>
        </div>
        <div>
            <img src="./public/images/hero-men.png" alt="">
            <p><span>Roney Tom</span> Developper Web <br> Phone: +000 145 000 77 88 <br> Email: contact@gmail.com</p>
        </div>
    </div>
</section>
...
<footer class="section-p1">
    <div class="col">
        ...
        <p><strong>Phone : </strong>+01 222 140 /(+90) 02 1470 6713</p>
        <p><strong>Hours : </strong>7:00 - 17:00, Mon - Sat</p>
        <div class="follow">
            <h4>Follow us</h4>
            <div class="icon">
